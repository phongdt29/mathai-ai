# Teacher Business Audit 2026-05-07T08-52-05-467Z

API: http://localhost:3001/api
WEB: http://localhost:3444
Summary: PASS 69 / FAIL 0 / WARN 1 / SKIP 16

## Workflow summary
| Workflow | Pass | Fail | Warn | Skip |
|---|---:|---:|---:|---:|
| Auth/Profile/RBAC/Scope | PASS 46 | FAIL 0 | WARN 1 | SKIP 4 |
...
| Gradebook workflow | PASS 2 | FAIL 0 | WARN 0 | SKIP 0 |
| Assignment workflow | PASS 2 | FAIL 0 | WARN 0 | SKIP 0 |
...
| PASS | Auth/Profile/RBAC/Scope | Detail assignment marker present in filtered list |  | 69fc52be705959de28ab5f5a |
| WARN | Auth/Profile/RBAC/Scope | Detail assignment direct endpoint contract check | /teacher/assignments/69fc52be705959de28ab5f5a | Direct detail endpoint chưa được expose; detail xác minh qua filtered list |
| PASS | Auth/Profile/RBAC/Scope | Teacher update assignment marker | /teacher/assignments/69fc52be705959de28ab5f5a | 200 |
| PASS | Auth/Profile/RBAC/Scope | Teacher assignment submissions before grading | /teacher/assignments/69fc52be705959de28ab5f5a/submissions | 200 |
| PASS | Auth/Profile/RBAC/Scope | Assignment seed submission marker via DB |  | 69fc52c0ea7bd7fefb462f2f |
| PASS | Auth/Profile/RBAC/Scope | Teacher assignment submissions after seed | /teacher/assignments/69fc52be705959de28ab5f5a/submissions | 200 |
| PASS | Assignment workflow | Teacher grade submission marker | /teacher/submissions/69fc52c0ea7bd7fefb462f2f/grade | 200 |
| PASS | Gradebook workflow | Teacher class gradebook after grading | /teacher/classes/69fc002c9f998e8ddff6b32a/gradebook | 200 |
| PASS | Auth/Profile/RBAC/Scope | Gradebook reflects graded assignment marker |  | 69fc52be705959de28ab5f5a |
| PASS | Auth/Profile/RBAC/Scope | Teacher gradebook student filter scoped | /teacher/gradebook?student_id=69e81b14eadbc114b25bca12 | 200 |
...
| PASS | Auth/Profile/RBAC/Scope | Teacher delete assignment cleanup marker | /teacher/assignments/69fc52be705959de28ab5f5a | 200 |
...
| PASS | Auth/Profile/RBAC/Scope | Content assignment detail marker teacher | /content-library/assignments/69fc52c4705959de28ab5fb9 | 200 |
| PASS | Auth/Profile/RBAC/Scope | Content assignment update marker teacher | /content-library/assignments/69fc52c4705959de28ab5fb9 | 200 |
| PASS | Auth/Profile/RBAC/Scope | Content assignment pause marker teacher | /content-library/assignments/69fc52c4705959de28ab5fb9/pause | 200 |
| PASS | Auth/Profile/RBAC/Scope | Content assignment activate marker teacher | /content-library/assignments/69fc52c4705959de28ab5fb9/activate | 200 |
| PASS | Auth/Profile/RBAC/Scope | Content assignment archive cleanup marker teacher | /content-library/assignments/69fc52c4705959de28ab5fb9 | 200 |
